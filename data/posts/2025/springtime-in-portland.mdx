...
and fell in love with large format. That's another fun fact: my first film camera
was a Crown Graphic. I dove right in.
...
what allowed me to diagnose the issue. The first shot I took with this
setup didn't work out at all, in part because I was so slow when I was learning
that I left the dark slide out so long that enough light leaked in through the
pinhole to totally ruin the image. I was unsure of what went wrong with those images,
but these made it obvious.
...
The office... it feels strange to admit that I've grown attached to it, but now that it's
...
The office is surrounded by trees that absolutely light up in the fall. It's quite the show.
...
Sometimes the lobby gets amazing light as well

<PostImageGroup>
  <PostImage props={props} index={9} />
</PostImageGroup>

I met basically my entire local social network through coworkers.
