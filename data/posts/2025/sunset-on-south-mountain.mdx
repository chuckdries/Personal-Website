...
date: 2025-01-20
bskyPost: https://bsky.app/profile/chuckdries.com/post/3lghme5fu7s2b
galleryImages:
...
<PostImageGroup>
  <PostImage alt="Ektachrome Sunset" index={0} />
  <PostImage alt="Portra 400 Sunset" index={2} />
  <PostImage alt="Ektachrome afterglow" index={3} />
</PostImageGroup>
...
<PostImageGroup>
  <PostImage
    alt="Sunset flares into the camera over mountainous desert and backlit saguaro"
       index={1}
  />
  <PostImage alt="Portra 160" index={5} />
  <PostImage alt="Portra 160" index={4} />
  <PostImage alt="Portra 160" index={6} />
  <PostImage alt="Portra 160" index={7} />
</PostImageGroup>
...
<PostImageGroup>
  <PostImage alt="Ektar 100" index={8} />
</PostImageGroup>
