...
type FileFieldsImageMeta = {
  readonly exif: Maybe<FileFieldsImageMetaExif>;
  readonly gps: Maybe<FileFieldsImageMetaGps>;
  readonly dateTaken: Maybe<Scalars['Date']>;
  readonly iptc: Maybe<FileFieldsImageMetaIptc>;
...
type FileFieldsImageMetaExif = {
  ...
  readonly ExposureBiasValue: Maybe<Scalars['Int']>;
  ...
  readonly Contrast: Maybe<Scalars['Int']>;
  readonly Saturation: Maybe<Scalars['Int']>;
...
type FileFieldsImageMetaExif_DateTimeOriginalArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type FileFieldsImageMetaExif_DateTimeDigitizedArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type FileFieldsImageMetaGps = {
  readonly longitude: Maybe<Scalars['Float']>;
  readonly latitude: Maybe<Scalars['Float']>;
};

type FileFieldsImageMetaIptc = {
  readonly date_created: Maybe<Scalars['Date']>;
  readonly time_created: Maybe<Scalars['String']>;
  readonly digital_date_created: Maybe<Scalars['Date']>;
  readonly digital_time_created: Maybe<Scalars['String']>;
  readonly caption: Maybe<Scalars['String']>;
  readonly date_time: Maybe<Scalars['Date']>;
  readonly by_line: Maybe<ReadonlyArray<Maybe<Scalars['String']>>>;
  readonly object_name: Maybe<Scalars['String']>;
  readonly keywords: Maybe<ReadonlyArray<Maybe<Scalars['String']>>>;
  readonly city: Maybe<Scalars['String']>;
  readonly province_or_state: Maybe<Scalars['String']>;
  readonly sub_location: Maybe<Scalars['String']>;
};


type FileFieldsImageMetaIptc_date_createdArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type FileFieldsImageMetaIptc_digital_date_createdArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type FileFieldsImageMetaIptc_date_timeArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type SitePageContext = {
  readonly imageFilename: Maybe<Scalars['String']>;
  readonly nextImage: Maybe<Scalars['String']>;
  readonly prevImage: Maybe<Scalars['String']>;
...
type FileFieldsFilterInput = {
  readonly imageMeta: Maybe<FileFieldsImageMetaFilterInput>;
};

type FileFieldsImageMetaFilterInput = {
  readonly exif: Maybe<FileFieldsImageMetaExifFilterInput>;
  readonly gps: Maybe<FileFieldsImageMetaGpsFilterInput>;
  readonly dateTaken: Maybe<DateQueryOperatorInput>;
  readonly iptc: Maybe<FileFieldsImageMetaIptcFilterInput>;
  readonly vibrant: Maybe<FileFieldsImageMetaVibrantFilterInput>;
};

type FileFieldsImageMetaExifFilterInput = {
  readonly _36880: Maybe<StringQueryOperatorInput>;
  readonly _36881: Maybe<StringQueryOperatorInput>;
  readonly _36882: Maybe<StringQueryOperatorInput>;
  readonly ExposureTime: Maybe<FloatQueryOperatorInput>;
  readonly FNumber: Maybe<FloatQueryOperatorInput>;
  readonly ExposureProgram: Maybe<IntQueryOperatorInput>;
  readonly ISO: Maybe<IntQueryOperatorInput>;
  readonly SensitivityType: Maybe<IntQueryOperatorInput>;
  readonly RecommendedExposureIndex: Maybe<IntQueryOperatorInput>;
  readonly DateTimeOriginal: Maybe<DateQueryOperatorInput>;
  readonly DateTimeDigitized: Maybe<DateQueryOperatorInput>;
  readonly ShutterSpeedValue: Maybe<FloatQueryOperatorInput>;
  readonly ApertureValue: Maybe<FloatQueryOperatorInput>;
  readonly BrightnessValue: Maybe<FloatQueryOperatorInput>;
  readonly ExposureBiasValue: Maybe<IntQueryOperatorInput>;
  readonly MaxApertureValue: Maybe<FloatQueryOperatorInput>;
  readonly MeteringMode: Maybe<IntQueryOperatorInput>;
  readonly LightSource: Maybe<IntQueryOperatorInput>;
  readonly Flash: Maybe<IntQueryOperatorInput>;
  readonly FocalLength: Maybe<IntQueryOperatorInput>;
  readonly ColorSpace: Maybe<IntQueryOperatorInput>;
  readonly FocalPlaneXResolution: Maybe<FloatQueryOperatorInput>;
  readonly FocalPlaneYResolution: Maybe<FloatQueryOperatorInput>;
  readonly FocalPlaneResolutionUnit: Maybe<IntQueryOperatorInput>;
  readonly CustomRendered: Maybe<IntQueryOperatorInput>;
  readonly ExposureMode: Maybe<IntQueryOperatorInput>;
  readonly WhiteBalance: Maybe<IntQueryOperatorInput>;
  readonly FocalLengthIn35mmFormat: Maybe<IntQueryOperatorInput>;
  readonly SceneCaptureType: Maybe<IntQueryOperatorInput>;
  readonly Contrast: Maybe<IntQueryOperatorInput>;
  readonly Saturation: Maybe<IntQueryOperatorInput>;
  readonly Sharpness: Maybe<IntQueryOperatorInput>;
  readonly LensSpecification: Maybe<FloatQueryOperatorInput>;
  readonly LensModel: Maybe<StringQueryOperatorInput>;
  readonly SubSecTimeOriginal: Maybe<StringQueryOperatorInput>;
  readonly SubSecTimeDigitized: Maybe<StringQueryOperatorInput>;
  readonly DigitalZoomRatio: Maybe<IntQueryOperatorInput>;
};

type FileFieldsImageMetaGpsFilterInput = {
  readonly longitude: Maybe<FloatQueryOperatorInput>;
  readonly latitude: Maybe<FloatQueryOperatorInput>;
};

type FileFieldsImageMetaIptcFilterInput = {
  readonly date_created: Maybe<DateQueryOperatorInput>;
  readonly time_created: Maybe<StringQueryOperatorInput>;
  readonly digital_date_created: Maybe<DateQueryOperatorInput>;
  readonly digital_time_created: Maybe<StringQueryOperatorInput>;
  readonly caption: Maybe<StringQueryOperatorInput>;
  readonly date_time: Maybe<DateQueryOperatorInput>;
  readonly by_line: Maybe<StringQueryOperatorInput>;
  readonly object_name: Maybe<StringQueryOperatorInput>;
  readonly keywords: Maybe<StringQueryOperatorInput>;
  readonly city: Maybe<StringQueryOperatorInput>;
  readonly province_or_state: Maybe<StringQueryOperatorInput>;
  readonly sub_location: Maybe<StringQueryOperatorInput>;
};

type FileFieldsImageMetaVibrantFilterInput = {
  readonly Vibrant: Maybe<IntQueryOperatorInput>;
  readonly DarkVibrant: Maybe<IntQueryOperatorInput>;
  readonly LightVibrant: Maybe<IntQueryOperatorInput>;
  readonly Muted: Maybe<IntQueryOperatorInput>;
  readonly DarkMuted: Maybe<IntQueryOperatorInput>;
  readonly LightMuted: Maybe<IntQueryOperatorInput>;
};
...
type FileFieldsEnum =
  ...
  | 'blksize'
  | 'blocks'
  | 'fields.imageMeta.exif._36880'
  | 'fields.imageMeta.exif._36881'
  | 'fields.imageMeta.exif._36882'
  | 'fields.imageMeta.exif.ExposureTime'
  | 'fields.imageMeta.exif.FNumber'
  | 'fields.imageMeta.exif.ExposureProgram'
  | 'fields.imageMeta.exif.ISO'
  | 'fields.imageMeta.exif.SensitivityType'
  | 'fields.imageMeta.exif.RecommendedExposureIndex'
  | 'fields.imageMeta.exif.DateTimeOriginal'
  | 'fields.imageMeta.exif.DateTimeDigitized'
  | 'fields.imageMeta.exif.ShutterSpeedValue'
  | 'fields.imageMeta.exif.ApertureValue'
  | 'fields.imageMeta.exif.BrightnessValue'
  | 'fields.imageMeta.exif.ExposureBiasValue'
  | 'fields.imageMeta.exif.MaxApertureValue'
  | 'fields.imageMeta.exif.MeteringMode'
  | 'fields.imageMeta.exif.LightSource'
  | 'fields.imageMeta.exif.Flash'
  | 'fields.imageMeta.exif.FocalLength'
  | 'fields.imageMeta.exif.ColorSpace'
  | 'fields.imageMeta.exif.FocalPlaneXResolution'
  | 'fields.imageMeta.exif.FocalPlaneYResolution'
  | 'fields.imageMeta.exif.FocalPlaneResolutionUnit'
  | 'fields.imageMeta.exif.CustomRendered'
  | 'fields.imageMeta.exif.ExposureMode'
  | 'fields.imageMeta.exif.WhiteBalance'
  | 'fields.imageMeta.exif.FocalLengthIn35mmFormat'
  | 'fields.imageMeta.exif.SceneCaptureType'
  | 'fields.imageMeta.exif.Contrast'
  | 'fields.imageMeta.exif.Saturation'
  | 'fields.imageMeta.exif.Sharpness'
  | 'fields.imageMeta.exif.LensSpecification'
  | 'fields.imageMeta.exif.LensModel'
  | 'fields.imageMeta.exif.SubSecTimeOriginal'
  | 'fields.imageMeta.exif.SubSecTimeDigitized'
  | 'fields.imageMeta.exif.DigitalZoomRatio'
  | 'fields.imageMeta.gps.longitude'
  | 'fields.imageMeta.gps.latitude'
  | 'fields.imageMeta.dateTaken'
  | 'fields.imageMeta.iptc.date_created'
  | 'fields.imageMeta.iptc.time_created'
  | 'fields.imageMeta.iptc.digital_date_created'
  | 'fields.imageMeta.iptc.digital_time_created'
  | 'fields.imageMeta.iptc.caption'
  | 'fields.imageMeta.iptc.date_time'
  | 'fields.imageMeta.iptc.by_line'
  | 'fields.imageMeta.iptc.object_name'
  | 'fields.imageMeta.iptc.keywords'
  | 'fields.imageMeta.iptc.city'
  | 'fields.imageMeta.iptc.province_or_state'
  | 'fields.imageMeta.iptc.sub_location'
...
type SitePageContextFilterInput = {
  readonly imageFilename: Maybe<StringQueryOperatorInput>;
  readonly nextImage: Maybe<StringQueryOperatorInput>;
  readonly prevImage: Maybe<StringQueryOperatorInput>;
...
type VibrantColorsFragment = Pick<FileFieldsImageMetaVibrant, 'DarkMuted' | 'DarkVibrant' | 'LightMuted' | 'LightVibrant' | 'Vibrant' | 'Muted'>;
...
type GalleryImageQuery = { readonly allFile: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<File, 'base'>
        & { readonly childImageSharp: Maybe<(
          Pick<ImageSharp, 'gatsbyImageData'>
          & { readonly fluid: Maybe<Pick<ImageSharpFluid, 'aspectRatio'>> }
        )>, readonly fields: Maybe<{ readonly imageMeta: Maybe<(
            Pick<FileFieldsImageMeta, 'dateTaken'>
            & { readonly iptc: Maybe<Pick<FileFieldsImageMetaIptc, 'caption' | 'object_name' | 'keywords' | 'city' | 'province_or_state'>>, readonly exif: Maybe<Pick<FileFieldsImageMetaExif, 'FNumber' | 'ExposureTime' | 'ISO'>>, readonly vibrant: Maybe<VibrantColorsFragment> }
          )> }> }
      ) }> } };
...
type HomepageQuery = { readonly allFile: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<File, 'relativePath' | 'base'>
        & { readonly childImageSharp: Maybe<(
          Pick<ImageSharp, 'gatsbyImageData'>
          & { readonly fluid: Maybe<Pick<ImageSharpFluid, 'aspectRatio'>> }
        )>, readonly fields: Maybe<{ readonly imageMeta: Maybe<{ readonly vibrant: Maybe<VibrantColorsFragment> }> }> }
      ) }> } };

type GalleryPageQueryQueryVariables = Exact<{ [key: string]: never; }>;


type GalleryPageQueryQuery = { readonly allFile: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<File, 'relativePath' | 'base'>
        & { readonly childImageSharp: Maybe<(
          Pick<ImageSharp, 'gatsbyImageData'>
          & { readonly fluid: Maybe<Pick<ImageSharpFluid, 'aspectRatio'>> }
            ...
            Pick<FileFieldsImageMeta, 'dateTaken'>
            & { readonly iptc: Maybe<Pick<FileFieldsImageMetaIptc, 'object_name'>> }
          )> }> }
      ) }> } };
