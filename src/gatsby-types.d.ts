...
type IndexPageQuery = { readonly mdx: { readonly frontmatter: { readonly slug: string | null, readonly title: string | null, readonly galleryImages: ReadonlyArray<{ readonly base: string, readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData, readonly fluid: { readonly aspectRatio: number } | null } | null } | null> | null } | null } | null, readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly frontmatter: { readonly slug: string | null, readonly title: string | null, readonly galleryImages: ReadonlyArray<{ readonly base: string, readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData, readonly fluid: { readonly aspectRatio: number } | null } | null } | null> | null } | null }> }, readonly file: { readonly fields: { readonly organization: { readonly month: number | null, readonly monthSlug: string | null, readonly yearFolder: string | null, readonly slug: string | null, readonly year: number | null } | null } | null } | null, readonly allFile: { readonly nodes: ReadonlyArray<{ readonly base: string, readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData, readonly fluid: { readonly aspectRatio: number } | null } | null }> } };
