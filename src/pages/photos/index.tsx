...
const Photos = ({ data }: PageProps<Queries.PhotosPageQueryQuery>) => {
...
export const query = graphql`
  query PhotosPageQuery {
    ...
    all: allFile(
      filter: {
        ...
        fields: { imageMeta: { meta: { Rating: { gte: 5 } } } }
      }
  ...
  fragment PhotoImageFile on FileConnection {
    nodes {
      id
      relativePath
      fields {
