      ...
      >
        <div
          className={classNames(
            "flex flex-nowrap items-center overflow-x-auto w-fit pr-3 lg:pr-6 gap-6 pb-2",
            !showScrollPrompt && "pl-3 lg:pl-6",
          )}
          ref={observeInner}
        >
          {showScrollPrompt && (
            <p className="text-nowrap lg:text-lg lg:mr-6 pr-3 pl-6 lg:pl-8 py-8 italic opacity-40 bg-[var(--tw-prose-body)] text-white rounded-r-full">
              <span className="pointer-coarse:hidden">scroll &rarr;</span>
              <span className="pointer-fine:hidden">swipe &larr;</span>
            </p>
          )}
